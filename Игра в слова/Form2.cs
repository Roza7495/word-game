...
namespace Игра_в_слова
{
 ...
 'о', 'п','р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я'};
            string[] do5 = new string[] { "пар", "часы", "порт", "бар", "баян", "мышь","кран", "рай", "дом", "чёрт",
"мир","фон","край","речь","рука","вера","стоп","стоп","вода","стул","свет","слот","слон","меч","дух","дуб","баня",
"кара","пила","тара"};
            Random rand = new Random();
            int i = rand.Next(31);
            string slovo = do5[i] ;
            Random rand1 = new Random();
            label3.Text = "Слово соситоит из " + slovo.Length+" букв ";
            
            //показ слова
            for (int i7 = 0; i7 < slovo.Length; i7++)
            {
                char a8 = slovo[i7];
                label4.Text = label4.Text + a8.ToString();
            }
            //прибавка букв к слову
            int i1;
               int i2;
            for (i1 =slovo.Length; i1 <8; i1 ++)
            { int ii = rand1.Next(34);
                slovo = slovo.Insert(i1,Alphabet[ii].ToString());
            }
            //вывод для проверки переделаного слова в текстбокс
            for (i1=0;i1<slovo.Length;i1++)
            {
                char a = slovo[i1];
        ...
        //ввод ника//вставка слова и букв в кнопки уровень до 5
 ...
 'о', 'п','р', 'с', 'т', 'у', 'ф', 'х', 'ц', 'ч', 'ш', 'щ', 'ъ', 'ы', 'ь', 'э', 'ю', 'я'};
            string[] do5 = new string[] { "пар", "часы", "порт", "бар", "баян", "мышь","кран", "рай", "дом", "чёрт",
"мир","фон","край","речь","рука","вера","стоп","крот","вода","стул","свет","слот","слон","меч","дух","дуб","баня",
"кара","пила","тара"};
            Random rand = new Random();
            int i = rand.Next(30);
            string slovo = do5[i];
            Random rand1 = new Random();
            label3.Text = "Слово состоит из " + slovo.Length + " букв ";
            //показ слова
            for (int i7 = 0; i7 < slovo.Length; i7++)
            {
                char a8 = slovo[i7];
            ...
            if (Equals(textBox1.Text, label4.Text)&&(textBox1.Text!=""))
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    StreamWriter writeRecordTabl = new StreamWriter(recordTabl1);
                        writeRecordTabl.WriteLine(label1.Text + "--------------1 уровень------------- " + recordTime);
                        label1.Text = "";
